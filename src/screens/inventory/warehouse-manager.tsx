                ...
                <ScrollView style={styles.whList} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                  <View style={styles.formSection}>
                    ...
                    <View style={styles.formActions}>
                      ...
                      <TouchableOpacity onPress={handleSave} style={[styles.addBtn, { flex: 1, height: 46, backgroundColor: colors.primary }]}>
                        <AppText variant="body" weight="bold" style={{ color: colors.background }}>{t('common.save')}</AppText>
                      </TouchableOpacity>
                    </View>
                  </View>
                </ScrollView>
