...
export function getInventoryGlass(colors: typeof LightTheme) {
  return createGlassTokens(colors);
}

export const INV_SPRING = {
...
export const INV_CARD_WIDTH = W * 0.45;
export const INV_CARD_GAP = 12;
