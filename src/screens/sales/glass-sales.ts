...
export function getSalesGlass(colors: typeof LightTheme) {
  return createGlassTokens(colors);
}

export const SALES_SPRING = {
...
export const SALES_CARD_WIDTH = W * 0.45;
export const SALES_CARD_GAP = 12;
