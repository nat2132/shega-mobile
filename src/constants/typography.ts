...
const TOKENS: Record<FontSizeVariant, Record<Weight, FontToken>> = {
  ...
  heading: {
    ...
    medium:     { fontSize: 20, lineHeight: 28, fontFamily: Fonts.medium,    fontWeight: '500' },
  ...
  'heading-lg': {
    ...
    medium:     { fontSize: 24, lineHeight: 30, fontFamily: Fonts.medium,    fontWeight: '500' },
  ...
  display: {
    ...
    medium:     { fontSize: 28, lineHeight: 34, fontFamily: Fonts.medium,    fontWeight: '500' },
  ...
  'display-lg': {
    ...
    medium:     { fontSize: 32, lineHeight: 38, fontFamily: Fonts.medium,    fontWeight: '500' },
  ...
  hero: {
    ...
    medium:     { fontSize: 40, lineHeight: 46, fontFamily: Fonts.medium,    fontWeight: '500' },
