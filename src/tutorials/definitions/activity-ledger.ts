...
export const activityLedgerTutorial: TutorialDefinition = {
  ...
  steps: [
...
},
    {
      ...
      targetId: 'al-feed',
      title: 'Activity Feed',
      description: 'Every action is listed here: sales, inventory changes, price adjustments, and payments received.',
      tooltipPosition: 'top',
      fullContainer: true,
},
    {
      ...
      description: 'Filter by activity type (sales, inventory, payments) or date range to find specific events.',
      tooltipPosition: 'top',
    },
  ],
};
