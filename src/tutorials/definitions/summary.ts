  ...
  steps: [
    {
      ...
      description: 'Your key financial metrics: total revenue, items sold, and outstanding amounts. Compare performance trends at a glance.',
      tooltipPosition: 'bottom',
      actionType: 'none',
    },
    {
    ...
    },
    {
      ...
      description: 'Track price adjustments and net profit at a glance. The top card shows cumulative price changes, while the bottom card displays your overall net profit after all losses.',
      tooltipPosition: 'top',
      actionType: 'none',
    },
  ],
